<!-- .aside -->
<aside class="bg-dark dk aside nav-vertical no-borders" id="nav">
    <section class="vbox">
        ...
        <section>
            <div class="nav-user hidden-xs pos-rlt">
                <div class="nav-avatar pos-rlt">
                    ...
                    <?php 
                      ...
                      {
                      ?>
                        <img src="<?php echo $config['site']; ?>UPLOAD_FILES/Images/Users_img/<?php echo $name_other; ?>" >
                      <?php
                      }
                      else
                      {
            ...
            <nav class="nav-primary hidden-xs">
                <ul class="nav">
                    ...
                    <li class="active">
                        <a href="#">
                            <i class="icon-file-text"></i><span>Data</span><span>&nbsp;admin</span>
                        </a>
                    </li>
                    <li>
                        <a href="../view-data-user/">
                            <i class="icon-file-text"></i><span>Data</span><span>&nbsp;user</span>
                        </a>
                    </li>
                </ul>
            </nav>
