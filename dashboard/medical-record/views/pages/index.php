                           ...
                           <section class="vbox">
                                 ...
                                 <section class="d-head-container">
                                    <div class="container" align="center">
                                       <span class="label label-danger pull-left label-font-size"><i class="icon-user-md"></i>&nbsp;ADMIN</span>
                                    ...
                                    <div class="container">
                                        <div class="content-container" align="center">
                                            ...
                                            <div class="fill-container g-m-rl-10">
                                                <span class="title-block" style="margin-bottom:15px;margin-top:16px;">PENGGUNA</span>
                                                <div class="icon-content-up spr-user block-a m-top" ></div>
                                                <span class="title-content"><?php 
                                                $masuk_user->hitung_jumlah_record_user();
                                                 ?></span>
                                            </div>
                                        </div>
                                    </div>
                                 ...
                                 <section class="action-panel" align="center">
                                    ...
                                    <div class="fill-container g-m-rl">
                                        <a href="view-data-admin/">
                                           <div class="icon-content-down spr-user"></div>
                                           <span class="title-content-down">PENGGUNA LKS</span>
                                        </a>
                                    </div>
                                  <!--<div class="fill-container g-m-rl">
                                       <a href="backup/">
                                           <div class="icon-content-down spr-backup"></div>
                                           <span class="title-content-down">BACKUP/RESTORE</span>
                                       </a>
                                    </div> -->
                                 </section>
                                 <footer class="labaga">
