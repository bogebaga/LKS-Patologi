...
<aside class="bg-danger dk aside nav-vertical no-borders" id="nav">
    <section class="vbox">
        <header class="nav-bar">
            ...
            <a class="btn btn-link visible-xs" data-toggle="class:show" data-target=".nav-user"> <i class="icon-user
            "></i> </a>
        </header>
        ...
        <section>
            ...
            <nav class="nav-primary hidden-xs">
                <ul class="nav">
                    ...
                    <li>
                        <a href="../view-data-lks/?lks=<?php echo $_GET['lks']; ?>#LKS-Merah">
                            <i class="icon-eye-open"></i><span>View</span><span>&nbsp;LKS</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li class="active">
                        <a href="#">
                            <i class="icon-edit"></i><span>Edit</span><span>&nbsp;LKS</span>
                        </a>
                    </li>
                </ul>
            </nav>
