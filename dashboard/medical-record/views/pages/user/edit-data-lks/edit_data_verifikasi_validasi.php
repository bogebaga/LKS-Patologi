		...
		<div class="panel-body" style="position:relative;" align="center">
			<div class="col-xs-6">
				...
				<!-- <label class="control-label">Jam:</label> -->
						<input id="jamverI" name="verifikator_i" style="width:100%" value="<?php echo $verifikator_i; ?>">	
			</div>
			...
			<div class="col-xs-6">
				...
				<!-- <label class="control-label">Jam:</label> -->
					<input id="jamverII" name="verifikator_ii" style="width:100%" value="<?php echo $verifikator_ii; ?>">	
			</div>
			...
			<div class="col-xs-6">
				...
				<!-- <label class="control-label" >Jam:</label> -->
					<input id="jamval" name="validasi" style="width:100%" value="<?php echo $validasi;?> ">		
			</div>	
			...
			<div class="col-xs-6">
				...
				<input type="text" class="form-control" name="interpretasi" placeholder="Interpretasi" value="<?php echo $interpretasi; ?>">
			</div>
