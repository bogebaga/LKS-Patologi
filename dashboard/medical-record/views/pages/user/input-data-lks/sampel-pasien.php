		<div class="clearfix">
			<label class="col-xs-2 control-label">Spesimen:</label>
				<label class="col-xs-2 checkbox-inline">
					<input type="checkbox" name="inputdarah">Darah
				</label>

				<label class="col-xs-2 checkbox-inline">
					<input type="checkbox" name="inputurine">Urine
				</label>
				<label class="col-xs-2 checkbox-inline">
					<input type="checkbox" name="inputfeses">Feses
				</label>
			
			<label class="col-xs-3 checkbox-inline">
				<input id="cb_cairan" type="checkbox">Cairan
				<input id="txt_cairan" type="text" placeholder="Isi cairan disini&hellip;" name="inputcairantext" style="width:80%;outline:none;border:none;" disabled="true">
			</label>
		</div>
		...
		<div class="clearfix">
			...
			<label class="col-xs-4 checkbox-inline">
				<input type="checkbox" name="inputvena">Vena
			</label>

			<label class="col-xs-4 checkbox-inline">
				<input id="cb_arteri" type="checkbox">Arteri&nbsp
				<input id="txt_arteri"type="text" name="inputarteritext" placeholder="Isi arteri disini&hellip;" style="width:85%;outline:none;border:none;" disabled="true">
			</label>
		</div>
		...
		<div class="clearfix">
			...
			<div class="col-xs-7">
				<div id="EDTA" class="col-xs-4">
					<label class="checkbox-inline">
						<input type="checkbox" name="inputEDTA">EDTA
					</label>
				...
				<div id="Plain" class="col-xs-4">
					<label class="checkbox-inline">
						<input type="checkbox" name="inputplain">Plain
					</label>
				...
				<div id="Citrate" class="col-xs-3">
					<label class="checkbox-inline">
						<input type="checkbox" name="inputcitrate">Citrate
					</label>
				...
				<div id="Heparin" class="col-xs-4">
					<label class="checkbox-inline">
						<input type="checkbox" name="inputheparin">Heparin
					</label>
				...
				<div id="SST" class="col-xs-4">
					<label class="checkbox-inline">
						<input type="checkbox" name="inputsst">SST
					</label>	
				...
				<div id="LED" class="col-xs-3">
					<label class="checkbox-inline">
						<input type="checkbox" name="inputled">LED
					</label>
			...
			<label class="col-xs-3 checkbox-inline" style="margin-top:10px;">
				<input id="cb_tabung"type="checkbox">
				<input id="txt_tabung"type="text" name="inputTubetext" placeholder="Isi jenis tabung disini&hellip;" style="width:85%;outline:none;border:none;" disabled="true">
			</label>
		</div>
		...
		<div class="clearfix">
			...
			<label class="col-xs-2 checkbox-inline">
				<input type="checkbox" name="inputbaik">Baik
			</label>
			<label class="col-xs-2 checkbox-inline">
				<input type="checkbox" name="inputlisis">Lisis
			</label>
			<label class="col-xs-2 checkbox-inline">
				<input type="checkbox" name="inputlipemik">Lipemik
			</label>
			<label class="col-xs-3 checkbox-inline">
				<input type="checkbox" name="inputikterik">Ikterik
			</label>
		</div>
		<div class="clearfix" style="margin-top:3px;">
			...
			<label class="col-xs-3 checkbox-inline">
				<input type="checkbox" name="inputcukup">Cukup
			</label>
			<label class="col-xs-3 checkbox-inline">
				<input type="checkbox" name="inputkurang">Kurang
			</label>
			<label class="col-xs-3 checkbox-inline">
				<input type="checkbox" name="inputskurang">Sangat Kurang
			</label>
		</div>	
		...
		<div class="clearfix">
			...
			<label class="col-xs-3 checkbox-inline" style="margin-left:10px;">
				<input type="checkbox" name="inputhematologi"><strong>Hematologi
			</strong></label>
		
			<label class="col-xs-3 checkbox-inline">
				<input type="checkbox" name="inputhemostatis"><strong>Hemostatis</strong>
			</label>
			
			<label class="col-xs-3 checkbox-inline">
				<input type="checkbox" name="inputanalisiscairan"><strong>Analisis Cairan</strong>
			</label>
			<label class="col-xs-3 checkbox-inline">
				<input type="checkbox" name="inputkimiaklinik"><strong>Kimia Klinik</strong>
			</label>
			
			<label class="col-xs-3 checkbox-inline">
				<input type="checkbox" name="inputimunoserologi"><strong>Imunoserologi</strong>
			</label>
		</div>
		...
		<div class="clearfix">
			...
			<label class="col-xs-3 checkbox-inline" style="margin-top:5px;">
				<input id="cb_anali"type="checkbox">
				<input id="txt_anali"type="text" name="inputAnalyzertext" placeholder="Isi Analyzer disini&hellip;" style="width:100%;outline:none;border:none;" disabled="true">
			</label>
		</div>